...
class Dashboard_model extends CI_Model 
{
	 ...
	 {
		 $query = $this->db->query('Select * from EA_procurement order by id desc limit 0,1');
		return $query->result_array();
	 }
	 public function get_EA_production()
	 {
		 $query = $this->db->query('Select * from EA_production order by id desc limit 0,1');
		return $query->result_array();
	 }
	 public function get_EA_marketing()
	 {
		 $query = $this->db->query('Select * from EA_marketing order by id desc limit 0,1');
		return $query->result_array();
	 }
	 public function get_EA_business()
	 {
		 $query = $this->db->query('Select * from EA_business order by id desc limit 0,1');
		return $query->result_array();
	 }
