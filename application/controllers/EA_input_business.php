                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo URL.'input/add/EA'; ?>" id="myForm">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['USD_INR_procurement']; ?></label>
                                    <div class="col-sm-10">
                                            <input type="text" class="form-control" name="USD_INR_procurement" id="USD_INR_procurement" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['SDS_USD']; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['SDS_USD_other']; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['SDS_USD_landed']; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['AA_USD']; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['AA_USD_other']; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['AA_USD_landed']; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?php echo $d['COAL_INR_landed']; ?></label>
                                    <div class="col-sm-10">
...
<script>
    ...
    .on("input", function() {
        ...
        $("#SDS_INR_landed").val(parseInt($("#SDS_USD_landed").val())*parseInt($("#USD_INR_procurement").val()));

        $("#AA_USD_landed").val(parseInt($("#AA_USD").val())+parseInt($("#AA_USD_other").val()));
        $("#AA_INR_landed").val(parseInt($("#AA_USD_landed").val())*parseInt($("#USD_INR_procurement").val()));
    });
</script>